...
public class UserBilling implements Serializable {
	...
	private String userBillignZibcode;
	...
	public String getUserBillignZibcode() {
		return userBillignZibcode;
	}

	public void setUserBillignZibcode(String userBillignZibcode) {
		this.userBillignZibcode = userBillignZibcode;
	}
